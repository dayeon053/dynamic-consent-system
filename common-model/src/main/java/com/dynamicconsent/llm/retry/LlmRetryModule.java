...
public class LlmRetryModule {
    ...
    private static String buildCorrectionPrompt(String failedOutput, String errorMessage) {
        return "이전 응답의 JSON 형식이 올바르지 않아 파싱에 실패했습니다.\n"
                ...
                + "4. itemType 허용값: REQUIRED | OPTIONAL\n"
                + "5. ds 허용값: LOW | MODERATE | HIGH\n"
                + "6. es 허용값: LOW | MEDIUM | HIGH\n"
                + "7. tf 허용값: SHORT | MEDIUM | LONG\n"
                + "8. pc 허용값: COMPLIANT | NON_COMPLIANT\n"
                + "9. ai 허용값: LOW_RISK | HIGH_RISK\n"
                + "10. 모든 값은 대문자로 출력\n\n"
                + "올바른 출력 예시:\n"
                + "{\n"
                + "  \"companyName\": \"기업명\",\n"
