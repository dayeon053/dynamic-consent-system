...
## 📚 기획 문서 (유즈케이스 / 개발 계획 / 위험도)
- [docs/유즈케이스_최종.md](docs/유즈케이스_최종.md) — 기능 요구사항(F1~F6), 유즈케이스(UC-01~07), 제약사항 정리
- [docs/유즈케이스_기반_태스크_목록.md](docs/유즈케이스_기반_태스크_목록.md) — Epic/태스크 단위 작업 목록, 스프린트 로드맵
- [docs/개발_계획.md](docs/개발_계획.md) — 스프린트별 담당자·작업 현황
- [docs/위험도.md](docs/위험도.md) — 위험도 산출 공식/변수 설계 배경
